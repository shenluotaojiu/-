...
public:
	...
	void on_draw()
	{
		...
		solidroundrect(position.x + 100, position.y + 10, position.x + 100 + width + 3, position.y + 36, 8, 8);
		...
		solidroundrect(position.x + 100, position.y + 40, position.x + 100 + (int)mp_bar_width + 3, position.y + 68, 8, 8);
